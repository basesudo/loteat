...
import agency_payment from "../assets/agency_payment.png";
...
const OtherModulePayment = (props) => {
  ...
  console.log('zoneData',zoneData?.data?.zone_data?.[0]?.agency_payment)
  console.log('configData',configData?.agency_payment)
  console.log('profileInfo',profileInfo?.agency_payment)
  return (
      ...
      <CustomStackFullWidth gap="20px">
        ...
        <CustomStackFullWidth spacing={1}>
          ...
          >
            ...
            {/* 新增 Agency Payment 选项 */}
            {zoneData?.data?.zone_data?.[0]?.agency_payment &&
            (configData?.agency_payment === true) && 
            (profileInfo?.agency_payment === true || profileInfo?.agency_payment === 1) ? (
              <PayButton
                value="agency_payment"
                paymentMethod={paymentMethod}
                onClick={() => handleClick("agency_payment")}
              >
                <CustomImageContainer
