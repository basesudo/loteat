...
export const agency_payment_share_api = "/agency-payment-share";
export const agency_payment_thank_you_api = "/agency-payment-thank-you";
export const agency_payment_process_api = "/agency-payment/process";


export const wallet_agency_payment_info_api = 'api/v1/wallet-agenc-payment-info';
export const agency_payment_success_api = '/agency-payment-success';
export const agency_payment_add_fund_api = '/agency-payment-add-fund';

export const region_currency_list = 'api/v1/region-currency/list';