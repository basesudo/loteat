                    ...
                    <table id="datatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0">{{ translate('messages.agency_payment') }}</th>
                                <th class="border-0">{{ translate('messages.recharge_agency_payment') }}</th>
                        ...
                        <tbody id="set-rows">
                            @foreach ($customers as $key => $customer)
                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm ml-xl-4" for="agencyPaymentCheckbox{{ $customer->id }}">
                                            <input type="checkbox" data-url="{{ route('admin.users.customer.agency-payment', [$customer->id, $customer->agency_payment ? 0 : 1]) }}" data-message="{{ $customer->agency_payment? translate('messages.you_want_to_disable_agency_payment'): translate('messages.you_want_to_enable_agency_payment') }}"
                                                class="toggle-switch-input agency_payment_change_alert" id="agencyPaymentCheckbox{{ $customer->id }}"
                                                {{ $customer->agency_payment ? 'checked' : '' }}>
                                            <span class="toggle-switch-label">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm ml-xl-4" for="rechargeAgencyPaymentCheckbox{{ $customer->id }}">
                                            <input type="checkbox" data-url="{{ route('admin.users.customer.recharge-agency-payment', [$customer->id, $customer->recharge_agency_payment ? 0 : 1]) }}" data-message="{{ $customer->recharge_agency_payment? translate('messages.you_want_to_disable_recharge_agency_payment'): translate('messages.you_want_to_enable_recharge_agency_payment') }}"
                                                class="toggle-switch-input recharge_agency_payment_change_alert" id="rechargeAgencyPaymentCheckbox{{ $customer->id }}"
                                                {{ $customer->recharge_agency_payment ? 'checked' : '' }}>
                                            <span class="toggle-switch-label">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
...
@push('script_2')
    ...
    <script>
        ...
        $('.agency_payment_change_alert').on('click', function (event) {
            let url = $(this).data('url');
            let message = $(this).data('message');
            agency_payment_change_alert(url, message, event)
        })

        $('.recharge_agency_payment_change_alert').on('click', function (event) {
            let url = $(this).data('url');
            let message = $(this).data('message');
            recharge_agency_payment_change_alert(url, message, event)
        })
        ...
        function agency_payment_change_alert(url, message, e) {
            e.preventDefault();
            Swal.fire({
                title: '{{ translate('messages.Are you sure?') }}',
                text: message,
        ...
        function recharge_agency_payment_change_alert(url, message, e) {
            e.preventDefault();
            Swal.fire({
                title: '{{ translate('messages.Are you sure?') }}',
                text: message,
