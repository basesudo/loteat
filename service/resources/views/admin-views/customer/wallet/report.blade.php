                    ...
                    <div class="row justify-content-end align-items-end g-3">
                        <div class="col-lg-4">
                            ...
                            <select name="transaction_type" id="add-fund-type" data-url="{{ url()->full() }}"
                                ...
                                <option
                                    value="deduct_fund_by_admin" {{isset($transaction_status) && $transaction_status=='deduct_fund_by_admin'?'selected':''}} >{{translate('messages.deduct_fund_by_admin')}}</option>
                                <option
                            ...
                            <tr scope="row">
                                ...
                                <td>
                                    <span class="badge badge-soft-{{
                                        $wt->transaction_type=='deduct_fund_by_admin'
                                            ? 'danger'
                                            : ($wt->transaction_type=='order_refund'
                                                ? 'danger'
