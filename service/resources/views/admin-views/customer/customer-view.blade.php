...
@section('content')
    <div class="content container-fluid">
        ...
        <!-- Payment Sharing List -->
        <div class="card mt-3">
            <!-- Header -->
            <div class="card-header">
                <h4 class="card-title">
                    <span>{{ translate('Payment Sharing List') }}</span>
                </h4>
            </div>
            <!-- End Header -->
                    ...
                    <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th>{{ translate('Agency ID') }}</th>
                                <th>{{ translate('Time') }}</th>
                                <th class="text-center">{{ translate('Action') }}</th>
                            </tr>
                        </thead>
                        <tbody>
                            @if(isset($wallet_payments) && count($wallet_payments) > 0)
                                @foreach($wallet_payments as $payment)
                                    <tr>
                                        <td>{{ $payment->id }}</td>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span class="badge badge-soft-info">{{ $payment->payment_status }}</span>
                                            @endif
                                        </td>
                                        <td>{{$payment->agency_id}}</td>
                                        <td>
                                            <div>
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                <a class="btn action-btn btn--primary btn-outline-primary" 
                                                   href="{{ route('admin.users.customer.wallet.agency-payment-details', $payment->agency_id) }}" 
                            ...
                            @else
                                <tr>
                                    <td colspan="5" class="text-center">{{ translate('No Records') }}</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
            ...
            <!-- Pagination -->
            @if(isset($wallet_payments) && $wallet_payments->total() > 0)
            <div class="card-footer">
                <div class="page-area">
                    {!! $wallet_payments->links() !!}
                </div>
            </div>
            @endif
            <!-- End Pagination -->
