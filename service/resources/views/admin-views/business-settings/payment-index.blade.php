        ...
        <div class="card border-0">
            ...
            <div class="card-body">
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        @php($AgencyPayment=\App\CentralLogics\Helpers::get_business_settings('agency_payment_status'))
                        <form action="{{route('admin.business-settings.third-party.payment-method-update',['agency_payment_status'])}}"
                              method="post" id="agency_payment_status_form">
                            @csrf
                            <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control">
                                <span class="pr-1 d-flex align-items-center switch--label">
                                    <span class="line--limit-1">
                                        {{translate('Agency Payment')}}
                                    </span>
                                    <span class="form-label-secondary text-danger d-flex" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('If_enabled_Customers_will_be_able_to_select_agency_payment_as_a_payment_method_during_checkout')}}"><img src="{{asset('public/assets/admin/img/info-circle.svg')}}" alt="Veg/non-veg toggle"> * </span>
                                </span>
                                <input type="hidden" name="toggle_type" value="agency_payment_status" >
                                <input  type="checkbox" id="agency_payment_status"
                                        data-id="agency_payment_status"
                                        data-type="status"
                                        data-image-on="{{ asset('/public/assets/admin/img/modal/digital-payment-on.png') }}"
                                        data-image-off="{{ asset('/public/assets/admin/img/modal/digital-payment-off.png') }}"
                                        data-title-on="{{ translate('By Turning ON Agency Payment Option') }}"
                                        data-title-off="{{ translate('By Turning OFF Agency Payment Option') }}"
                                        data-text-on="<p>{{ translate('Customers will not be able to select Agency Payment as a payment method during checkout. Please review your settings and enable Agency Payment if you wish to offer this payment option to customers.') }}</p>"
                                        data-text-off="<p>{{ translate('Customers will be able to select Agency Payment as a payment method during checkout.') }}</p>"
                                        class="status toggle-switch-input dynamic-checkbox"
                                        name="status" value="1" {{$AgencyPayment?($AgencyPayment['status']==1?'checked':''):''}}>
                                <span class="toggle-switch-label text">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
                    ...
                    <div class="col-md-4">
                        @php($AddFundPayment=\App\CentralLogics\Helpers::get_business_settings('add_fund_payment_status'))
                        <form action="{{route('admin.business-settings.third-party.payment-method-update',['add_fund_payment_status'])}}"
                            method="post" id="add_fund_payment_status_form">
                            @csrf
                            <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control">
                                <span class="pr-1 d-flex align-items-center switch--label">
                                    <span class="line--limit-1">
                                        {{translate('Add Fund Payment')}}
                                    </span>
                                    <span class="form-label-secondary text-danger d-flex" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('If_enabled_Customers_will_be_able_to_select_add_fund_payment_as_a_payment_method_during_checkout')}}"><img src="{{asset('public/assets/admin/img/info-circle.svg')}}" alt="Veg/non-veg toggle"> * </span>
                                </span>
                                <input type="hidden" name="toggle_type" value="add_fund_payment_status" >
                                <input type="checkbox" id="add_fund_payment_status"
                                        data-id="add_fund_payment_status"
                                        data-type="status"
                                        data-image-on="{{ asset('/public/assets/admin/img/modal/digital-payment-on.png') }}"
                                        data-image-off="{{ asset('/public/assets/admin/img/modal/digital-payment-off.png') }}"
                                        data-title-on="{{ translate('By Turning ON Add Fund Payment Option') }}"
                                        data-title-off="{{ translate('By Turning OFF Add Fund Payment Option') }}"
                                        data-text-on="<p>{{ translate('Customers will not be able to select Add Fund Payment as a payment method during checkout. Please review your settings and enable Add Fund Payment if you wish to offer this payment option to customers.') }}</p>"
                                        data-text-off="<p>{{ translate('Customers will be able to select Add Fund Payment as a payment method during checkout.') }}</p>"
                                        class="status toggle-switch-input dynamic-checkbox"
                                        name="status" value="1" {{$AddFundPayment?($AddFundPayment['status']==1?'checked':''):''}}>
                                <span class="toggle-switch-label text">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
