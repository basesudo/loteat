            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/customer/wallet*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('admin/users/customer/wallet*') ? 'block' : 'none' }}">
                        ...
                        <li class="nav-item {{ Request::is('admin/users/customer/wallet/deduct-fund') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.users.customer.wallet.deduct-fund') }}" title="{{ translate('messages.deduct_fund') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate text-capitalize">{{ translate('messages.deduct_fund') }}</span>
                            </a>
                        </li>
