                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('settings'))
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/pages*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/pages/agency-payment-page*') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:" title="{{ translate('messages.agency_payment_pages') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.agency_payment_pages') }}</span>
                                    </a>
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                        style="display:{{ Request::is('admin/business-settings/pages/agency-payment*') ? 'block' : 'none' }}">
                                        <li class="nav-item {{ Request::is('admin/business-settings/pages/agency-payment-page/agency-payment-share') ? 'active' : '' }}">
                                            <a class="nav-link "
                                            href="{{ route('admin.business-settings.agency-payment-share') }}"
                                            title="{{ translate('messages.share_page_settings') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span class="text-truncate">{{ translate('messages.share_page_settings') }}</span>
                                            </a>
                                        </li>

                                        <li class="nav-item {{ Request::is('admin/business-settings/pages/agency-payment-page/agency-payment-thank-you') ? 'active' : '' }}">
                                            <a class="nav-link "
                                            href="{{ route('admin.business-settings.agency-payment-thank-you') }}"
                                            title="{{ translate('messages.thank_you_page_settings') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span class="text-truncate">{{ translate('messages.thank_you_page_settings') }}</span>
                                            </a>
                                        </li>
                                        
                                        <li class="nav-item {{ Request::is('admin/business-settings/pages/agency-payment-page/agency-payment-add-fund') ? 'active' : '' }}">
                                            <a class="nav-link "
                                            href="{{ route('admin.business-settings.agency-payment-add-fund') }}"
                                            title="{{ translate('messages.add_fund_page_settings') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span class="text-truncate">{{ translate('messages.add_fund_page_settings') }}</span>
                                            </a>
                                        </li>

                                        <li class="nav-item {{ Request::is('admin/business-settings/pages/agency-payment-page/agency-payment-success') ? 'active' : '' }}">
                                            <a class="nav-link "
                                            href="{{ route('admin.business-settings.agency-payment-success') }}"
                                            title="{{ translate('messages.thank_you_page') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span class="text-truncate">{{ translate('messages.thank_you_page') }}</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
