        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <!-- Payment Management -->
                    @if (\App\CentralLogics\Helpers::module_permission_check('payment'))
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/payment/*') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:" 
                        title="{{ translate('messages.payment_management') }}">
                            <i class="tio-money nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                {{ translate('messages.payment_management') }}
                            </span>
                        </a>
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" 
                            style="display: {{ Request::is('admin/payment*') ? 'block' : 'none' }}">
                            
                            <li class="nav-item {{ Request::is('admin/payment/list') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.payment.list') }}" 
                                title="{{ translate('messages.payment_list') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate sidebar--badge-container">
                                        {{ translate('messages.payment_list') }}
                                        <span class="badge badge-soft-info badge-pill ml-1">
                                            {{ \App\Models\PaymentRequest::count() }}
                                        </span>
                                    </span>
                                </a>
                            </li>
                            
                            <li class="nav-item {{ Request::is('admin/payment/list') && request()->payment_status == '0' ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.payment.list') }}?payment_status=0" 
                                title="{{ translate('messages.unpaid_payments') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate sidebar--badge-container">
                                        {{ translate('messages.unpaid') }}
                                        <span class="badge badge-soft-danger badge-pill ml-1">
                                            {{ \App\Models\PaymentRequest::where('is_paid', 0)->count() }}
                                        </span>
                                    </span>
                                </a>
                            </li>
                            
                            <li class="nav-item {{ Request::is('admin/payment/list') && request()->payment_status == '1' ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.payment.list') }}?payment_status=1" 
                                title="{{ translate('messages.paid_payments') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate sidebar--badge-container">
                                        {{ translate('messages.paid') }}
                                        <span class="badge badge-soft-success badge-pill ml-1">
                                            {{ \App\Models\PaymentRequest::where('is_paid', 1)->count() }}
                                        </span>
                                    </span>
                                </a>
                            </li>
                            
                            <li class="nav-item {{ Request::is('admin/payment/list') && request()->attribute == 'order' ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.payment.list') }}?attribute=order" 
                                title="{{ translate('messages.order_payments') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate sidebar--badge-container">
                                        {{ translate('messages.order_payments') }}
                                        <span class="badge badge-soft-primary badge-pill ml-1">
                                            {{ \App\Models\PaymentRequest::where('attribute', 'order')->count() }}
                                        </span>
                                    </span>
                                </a>
                            </li>
                            
                            <li class="nav-item {{ Request::is('admin/payment/list') && request()->attribute == 'wallet_payments' ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.payment.list') }}?attribute=wallet_payments" 
                                title="{{ translate('messages.wallet_payments') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate sidebar--badge-container">
                                        {{ translate('messages.wallet_payments') }}
                                        <span class="badge badge-soft-info badge-pill ml-1">
                                            {{ \App\Models\PaymentRequest::where('attribute', 'wallet_payments')->count() }}
                                        </span>
                                    </span>
                                </a>
                            </li>
