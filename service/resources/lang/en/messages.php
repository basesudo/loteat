...
',
  ...
  'Customers will be able to select Agent Payment as a payment method during checkout.' => 'Customers will be able to select Agent Payment as a payment method during checkout.',
  'Customers will be able to select Agency Payment as a payment method during checkout.' => 'Customers will be able to select Agency Payment as a payment method during checkout.',
  'Customers will not be able to select Agency Payment as a payment method during checkout. Please review your settings and enable Agency Payment if you wish to offer this payment option to customers.' => 'Customers will not be able to select Agency Payment as a payment method during checkout. Please review your settings and enable Agency Payment if you wish to offer this payment option to customers.',
  'By Turning OFF Agency Payment Option' => 'By Turning OFF Agency Payment Option',
  'By Turning ON Agency Payment Option' => 'By Turning ON Agency Payment Option',
  '500_warning_message' => '500 warning message',
  'If_enabled_Customers_will_be_able_to_select_agency_payment_as_a_payment_method_during_checkout' => 'If enabled Customers will be able to select agency payment as a payment method during checkout',
  'Agency Payment' => 'Agency Payment',
  'agency_payment' => 'Agency payment',
  'you_want_to_enable_agency_payment' => 'You want to enable agency payment',
  'you_want_to_disable_agency_payment' => 'You want to disable agency payment',
  ...
  'If_yes,_Customers_can_choose_the_Agency_Payment_option_during_checkout.' => 'If yes, Customers can choose the Agency Payment option during checkout.',
  'If_yes,_Customers_can_choose_the_’Agency_Payment’_option_during_checkout.' => 'If yes, Customers can choose the ’Agency Payment’ option during checkout.',
  'Want_to_enable_’Agency_Payment’?' => 'Want to enable ’Agency Payment’?',
  'If_yes,_the_agency_payment_option_will_be_hidden_during_checkout.' => 'If yes, the agency payment option will be hidden during checkout.',
  'Want_to_disable_’Agency_Payment’?' => 'Want to disable ’Agency Payment’?',
  ...
  'agency payment' => 'Agency payment',
  'agency_payment_pages' => 'Agency payment pages',
  'thank_you_page_settings' => 'Thank you page settings',
  'share_page_settings' => 'Share page settings',
  'Agency Payment Share' => 'Agency Payment Share',
  'Agency Payment Thank You' => 'Agency Payment Thank You',
  'agency_payment_share_updated' => 'Agency payment share updated',
  'agency_payment_thank_you_updated' => 'Agency payment thank you updated',
  ...
  'anonymous_payer' => 'Anonymous payer',
  'zone_agency_payment_status_updated' => 'Zone agency payment status updated',
  'order_not_found' => 'Order not found',
  'you_want_to_enable_recharge_agency_payment' => 'You want to enable recharge agency payment',
  'you_want_to_disable_recharge_agency_payment' => 'You want to disable recharge agency payment',
  'recharge_agency_payment' => 'Recharge agency payment',
  'Customers will be able to select Add Fund Payment as a payment method during checkout.' => 'Customers will be able to select Add Fund Payment as a payment method during checkout.',
  'Customers will not be able to select Add Fund Payment as a payment method during checkout. Please review your settings and enable Add Fund Payment if you wish to offer this payment option to customers.' => 'Customers will not be able to select Add Fund Payment as a payment method during checkout. Please review your settings and enable Add Fund Payment if you wish to offer this payment option to customers.',
  'By Turning OFF Add Fund Payment Option' => 'By Turning OFF Add Fund Payment Option',
  'By Turning ON Add Fund Payment Option' => 'By Turning ON Add Fund Payment Option',
  'If_enabled_Customers_will_be_able_to_select_add_fund_payment_as_a_payment_method_during_checkout' => 'If enabled Customers will be able to select add fund payment as a payment method during checkout',
  'hhhh' => 'Hhhh',
  'wwwww' => 'Wwwww',
  'Add Fund Payment' => 'Add Fund Payment',
  'store_added_successfully' => 'Store added successfully',
  'thank_you_page' => 'Thank you page',
  'add_fund_page_settings' => 'Add fund page settings',
  'Agency Payment Add Fund' => 'Agency Payment Add Fund',
  'agency_payment_add_fund_updated' => 'Agency payment add fund updated',
  'Agency Payment Success' => 'Agency Payment Success',
  'agency_payment_success_updated' => 'Agency payment success updated',
  'wallet_payment_not_found' => 'Wallet payment not found',
  'agency_id_required' => 'Agency id required',
  'successfully_updated' => 'Successfully updated',
  'agency_payment_info_version_created_successfully' => 'Agency payment info version created successfully',
  ...
  '支付方式' => '支付方式',
  'Success' => 'Success',
  'Payment Sharing List' => 'Payment Sharing List',
  'View Details' => 'View Details',
  'Referrer' => 'Referrer',
  'Agency ID' => 'Agency ID',
  'Payment_details' => 'Payment details',
  'No detailed information found' => 'No detailed information found',
  'images' => 'Images',
  'content' => 'Content',
  'Loading...' => 'Loading...',
  ...
  'deadd_fund_by_admin' => 'Deadd fund by admin',
  'deduct_fund' => 'Deduct fund',
  'fund_deducted_successfully' => 'Fund deducted successfully',
  'you_want_to_deduct_fund' => 'You want to deduct fund',
  ...
  'Phone number should only contain digits.' => 'Phone number should only contain digits.',
  'Payment failed' => 'Payment failed',
  'Invalid expiry date.' => 'Invalid expiry date.',
  'Invalid CVV format.' => 'Invalid CVV format.',
  'Invalid card number format.' => 'Invalid card number format.',
  'Processing payment...' => 'Processing payment...',
  'An error occurred. Please try again.' => 'An error occurred. Please try again.',
  'Street is required.' => 'Street is required.',
  'House number/name is required.' => 'House number/name is required.',
  'Go Back' => 'Go Back',
  ...
  'Submitting payment details securely...' => 'Submitting payment details securely...',
  ...
  'Initializing secure payment processing...' => 'Initializing secure payment processing...',
  'Payment Amount' => 'Payment Amount',
  'Secure payment processing powered by Nova2Pay' => 'Secure payment processing powered by Nova2Pay',
  'Complete Your Payment' => 'Complete Your Payment',
  'Email is required.' => 'Email is required.',
  'Payment Error' => 'Payment Error',
  'Last name is required.' => 'Last name is required.',
  'Please wait while we process your payment securely' => 'Please wait while we process your payment securely',
  ...
  'Invalid payment request parameters' => 'Invalid payment request parameters',
  ...
  'payment_request_created' => 'Payment request has been created',
  'payment_successfully_completed' => 'Payment has been successfully completed',
  'related_information' => 'Related Information',
  'payer_info' => 'Payer Information',
  'payer_id' => 'Payer ID',
  'receiver_id' => 'Receiver ID',
  'attribute_id' => 'Attribute ID',
  'search_by_id_transaction_id' => 'Search by ID or Transaction ID',
  ...
  'Phone number should only contain digits, spaces, and +()-' => 'Phone number should only contain digits, spaces, and +()-',
  'Street address is required.' => 'Street address is required.',
  'Cardholder last name is required.' => 'Cardholder last name is required.',
  'Cardholder first name is required.' => 'Cardholder first name is required.',
  'CVV must be 3-4 digits.' => 'CVV must be 3-4 digits.',
  ...
  'Card number must be 16 digits.' => 'Card number must be 16 digits.',
  ...
  'Secure payment processing powered by UPrimer' => 'Secure payment processing powered by UPrimer',
  'uprimer_3ds_payment_creation_failed' => 'Uprimer 3ds payment creation failed',
  'uprimer_3ds_payment_response' => 'Uprimer 3ds payment response',
  'Wallet Payment' => 'Wallet Payment',
  'order_payment' => 'Order payment',
  'Turn_On_push_notification_for' => 'Turn On push notification for',
  'Please wait for payment processing...' => 'Please wait for payment processing...',
