...
class ZoneController extends BaseController
{
    ...
    public function updateAgencyPayment(Request $request): RedirectResponse
    {
        $this->zoneRepo->update(id: $request['id'] ,data: ['agency_payment' => $request['agency_payment']]);
        Toastr::success(translate('messages.zone_agency_payment_status_updated'));
        return back();
    }
