...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    Route::get('wallet-agenc-payment-info', 'WalletController@wallet_agency_payment_info')
    ->name('wallet_agency_payment_info');
    Route::POST('update-agency-payment-content', 'WalletController@update_agency_payment_content')
    ->name('update_agency_payment_content')->middleware('auth:api');
    ...
    // 地区和汇率相关接口
    Route::group(['prefix' => 'region-currency'], function () {
        Route::get('/list', 'GetRegionAndCurrencyController@index')->withoutMiddleware(['auth:api', 'module-check']);
    });
    ...
    Route::group(['middleware'=>['module-check']], function(){
        Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
            ...
            Route::group(['prefix'=>'wallet'], function() {
                ...
                Route::post('process-agency-payment', 'WalletController@process_agency_payment')->withoutMiddleware('auth:api');
                #handshake
