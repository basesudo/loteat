...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'current-module']], function () {
        ...
        Route::group(['prefix' => 'payment', 'as' => 'payment.'], function () {
            Route::get('list', 'PaymentController@list')->name('list');
            Route::post('filter', 'PaymentController@filter')->name('filter');
            Route::get('filter/reset', 'PaymentController@filter_reset')->name('filter_reset');
            Route::get('statistics', 'PaymentController@statistics')->name('statistics');
        });
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:settings', 'actch']], function () {
            ...
            // 代付分享页面路由
            Route::get('pages/agency-payment-page/agency-payment-share', 'BusinessSettingsController@agency_payment_share')->name('agency-payment-share');
            Route::post('pages/agency-payment-page/agency-payment-share', 'BusinessSettingsController@agency_payment_share_update');
            Route::get('pages/agency-payment-share/{status}', 'BusinessSettingsController@agency_payment_share_status')->name('agency-payment-share-status');

            // 代付感谢页面路由
            Route::get('pages/agency-payment-page/agency-payment-thank-you', 'BusinessSettingsController@agency_payment_thank_you')->name('agency-payment-thank-you');
            Route::post('pages/agency-payment-page/agency-payment-thank-you', 'BusinessSettingsController@agency_payment_thank_you_update');
            Route::get('pages/agency-payment-thank-you/{status}', 'BusinessSettingsController@agency_payment_thank_you_status')->name('agency-payment-thank-you-status');

            // 代付充值页面路由
            Route::get('pages/agency-payment-page/agency-payment-add-fund', 'BusinessSettingsController@agency_payment_add_fund')->name('agency-payment-add-fund');
            Route::post('pages/agency-payment-page/agency-payment-add-fund', 'BusinessSettingsController@agency_payment_add_fund_update');
            Route::get('pages/agency-payment-add-fund/{status}', 'BusinessSettingsController@agency_payment_add_fund_status')->name('agency-payment-add-fund-status');

            // 代付成功页面路由
            Route::get('pages/agency-payment-page/agency-payment-success', 'BusinessSettingsController@agency_payment_success')->name('agency-payment-success');
            Route::post('pages/agency-payment-page/agency-payment-success', 'BusinessSettingsController@agency_payment_success_update');
            Route::get('pages/agency-payment-success/{status}', 'BusinessSettingsController@agency_payment_success_status')->name('agency-payment-success-status');
        ...
        Route::group(['prefix' => 'users', 'as' => 'users.'], function () {
            ...
            Route::group(['prefix' => 'customer', 'as' => 'customer.'], function () {
                ...
                Route::group(['prefix' => 'wallet', 'as' => 'wallet.', 'middleware' => ['module:customer_management']], function () {
                    Route::get('add-fund', 'CustomerWalletController@add_fund_view')->name('add-fund');
                    Route::post('add-fund', 'CustomerWalletController@add_fund');
                    Route::get('deduct-fund', 'CustomerWalletController@deduct_fund_view')->name('deduct-fund');
                    Route::post('deduct-fund', 'CustomerWalletController@deduct_fund');
                    ...
                    Route::get('agency-payment-details/{agency_id}', 'CustomerWalletController@agency_payment_details')->name('agency-payment-details');
                });
            ...
            Route::group(['prefix' => 'customer', 'as' => 'customer.', 'middleware' => ['module:customer_management']], function () {
                ...
                Route::get('agency-payment/{customer}/{status}', 'CustomerController@agencyPayment')->name('agency-payment');
                Route::get('recharge-agency-payment/{customer}/{status}', 'CustomerController@rechargeAgencyPayment')->name('recharge-agency-payment');
            });
